...
public class thursday_todo_list extends javax.swing.JFrame {
 int n[]=new int[18];
    
    public thursday_todo_list() {
        initComponents();
          setLocationRelativeTo(null);
         setTitle("  HEALTHY LIFESTYLE  ");
    }
public thursday_todo_list(String s) {
        initComponents();
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        new thursday_todo_list().setVisible(false);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(thursday_todo_list.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new thursday_todo_list().setVisible(true);
            }
        });
    }
